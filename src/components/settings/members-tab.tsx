        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              A URL de convite em texto puro é exibida apenas uma vez na criação,
              por segurança — para recompartilhar, revogue o convite abaixo e
              crie um novo.
            </p>
          ) : null}
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              da conta? Ele será desconectado desta conta e receberá uma conta
              pessoal nova no próximo login. O login não será excluído.
            </DialogDescription>
          </DialogHeader>
