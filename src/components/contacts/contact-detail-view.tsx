...
import type { Contact, Tag, ContactTag, ContactNote, CustomField, ContactCustomValue, Deal, Fap01Data } from '@/types';
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
function Fap01Section({ title, rows }: { title: string; rows: [string, string | null][] }) {
...
function Fap01Tab({ data }: { data?: Fap01Data | null }) {
  if (!data) {
    return (
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          placeholder={`Preencher ${field.field_name}...`}
