...
export function NodeConfigForm({
  ...
  switch (node.node_type) {
    ...
    case "handoff":
      return (
        <TextRow
          label="Nota interna (para o atendente que receber)"
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          Nó terminal. Quando o motor chega a este nó, a execução é marcada como concluída. Nenhuma configuração necessária.
        </p>
      );
  }
}
