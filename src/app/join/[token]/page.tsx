...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça pra quem te convidou enviar um novo.',
  },
  used: {
    title: 'Convite já utilizado',
    body: 'Este convite já foi aceito. Se não foi você, peça pro admin da conta enviar um link novo.',
  },
  expired: {
    title: 'Convite expirado',
    body: 'Este convite expirou. Peça pro admin da conta enviar um novo — leva uns segundos pra gerar.',
  },
  server_error: {
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-popover-foreground">
                ...
                Não dá pra entrar em {peek.account_name} com esta conta
              </DialogTitle>
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                saia e cadastre-se de novo com outro e-mail. O link do
                convite continua válido enquanto não expirar.
              </p>
            </div>
