...
export default function NewBroadcastPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      {/* Header */}
      <div>
        <h1 className="font-mono text-2xl font-bold text-foreground"><span className="text-primary">▸</span> novo disparo</h1>
        <p className="mt-1 font-mono text-sm text-muted-foreground">
          # crie e envie um disparo de mensagem para seus contatos
        </p>
      </div>
